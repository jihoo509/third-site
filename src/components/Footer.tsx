        ...
        <div className="bg-black bg-opacity-20 border-t border-white/10">
          <div className="w-full max-w-5xl mx-auto py-10 px-6">
            ...
            <div className="text-xs text-white/60 space-y-2.5">
              ...
              <p>종신보험은 피보험 사망을 보장하는 보장성보험으로 저축(연금) 목적에는 적합하지 않습니다.</p>
              <p>일반사망보험금은 고의적 사고 및 2년 이내 자살의 경우 지급이 제한됩니다.</p>
              <p>중도해약 시 환급금이 이미 납부한 보험료보다 적거나 없을 수 있습니다.</p>
            ...
            <div className="mt-6 text-xs text-white/40">
              <p>설계사 신지후 (손.생보 협회 등록번호 202507-2000-3328), 프라임에셋심의필 제2025-09-5364호(2025-09-22 ~ 2026-09-21)</p>
            </div>
